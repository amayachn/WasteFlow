    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <!-- Home dropdown for Admin -->
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="dashboard_admin.php" id="homeDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Home
            </a>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="homeDropdown">
              <li><a class="dropdown-item" href="register_admin.php">Register Admin</a></li>
