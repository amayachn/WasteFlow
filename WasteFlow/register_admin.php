...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif(!preg_match('/^[0-9]{11}$/', $contact)){
        ...
        if($check->num_rows > 0){
            ...
            // ✅ Explicit role binding (admin)
            $sql = $conn->prepare("INSERT INTO users (name, purok, contact_number, password, role) VALUES (?,?,?,?,?)");
            $role = "admin"; 
            $sql->bind_param("sssss", $name, $purok, $contact, $password, $role);
...
<div class="container d-flex justify-content-center align-items-center mt-5">
  <div class="card shadow-lg" style="max-width: 500px; width: 100%;" id="registerCard">
    ...
    <div class="card-body">
      <form method="POST" action="register_admin.php" class="row g-3" id="registerForm">
        <div class="col-12">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <p>You have successfully registered as an admin.</p>
      </div>
